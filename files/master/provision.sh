...
DEBIAN_FRONTEND=noninteractive apt-get install -y syslog-ng openssh-server bash-completion less leafpad mupdf xnest apache2 vim xfce4 thunderbird epiphany-browser tcpdump dsniff whois wireshark net-tools xfce4-terminal iptables iputils-ping netcat nmap socat curl wget unzip # keyboard-configuration  wireshark firmware-atheros firmware-misc-nonfree
apt-get clean
# firefox-esr
