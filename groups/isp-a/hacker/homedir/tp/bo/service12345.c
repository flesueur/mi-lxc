...
//	printf("\n\n--DEBUG--adresses de read=%x, main=%x, prepare=%x, launch=%x, armageddon=%x\n",(unsigned int)&read,(unsigned int)&main,(unsigned int)&prepare,(unsigned int)&launch,(unsigned int)&armageddon);
